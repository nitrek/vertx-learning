...
var Message = function(j_val, j_arg_0) {
  ...
  this.reply =  function() {
    ...
    if (__args.length === 1 && typeof __args[0] !== 'function') {
      ...
      j_message["reply(java.lang.Object,io.vertx.core.eventbus.DeliveryOptions,io.vertx.core.Handler)"](utils.convParamTypeUnknown(__args[0]), __args[1]  != null ? new DeliveryOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null, function(ar) {
        if (ar.succeeded()) {
  ...
  this.fail =  function(failureCode, message) {
    ...
    if (__args.length === 2 && typeof __args[0] ==='number' && typeof __args[1] === 'string') {
      j_message["fail(int,java.lang.String)"](__args[0], __args[1]);
